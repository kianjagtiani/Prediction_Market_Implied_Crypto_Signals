...
Kalshi candlesticks for the top BTC-correlated markets identified in notebook 02,
...
def write_report(
    ...
    if backtest_tests.empty:
        ...
        cols = ["definition", "holding_period", "sharpe", "ann_ret_pct", "max_drawdown_pct", "win_rate_pct", "n_trades", "signal_events"]
